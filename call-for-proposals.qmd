...
The dataset available to selected research proposals will comprise tracking and event data from SkillCorner covering the 2023 National Women's Soccer League season (132 matches) and the 2023-24 English Women's Super League season (132 matches). In addition to player and ball tracking, SkillCorner's [Game Intelligence](https://skillcorner.com/contextual-data){target="_blank"} data provide Dynamic Events such as passes, player possessions/carries, and off-ball runs, as well as player-level aggregations of physical performance metrics (total distance, sprints, high-intensity activity, acceleration, etc.).
